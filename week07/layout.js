...
function layout(element) {
    ...
    for (var i = 0; i < items.length; i ++) {
        ...
        if (itemStyle.flex) {
            ...
            if (itemStyle[crossSign] !== null && itemStyle[crossSize]) {
                crossSpace = Math.max(srossSpace, itemStyle[crossSize])
            }
            flexLine.push(item);
        } else {
    ...
    if (mainSpace < 0) {
        ...
        flexLines.forEach(function(items) {
            ...
            for (var i = 0; i < items.length; i ++) {
                ...
                if ((itemStyle.flex !== null) && (itemStyle.flex !== "")) {
    ...
    if (style.flexWrap === "wrap-reverse") {
        crossBase -= flexLines[i].crossSpace;
    } else {
        crossBase = 0;
    }
