...
class ResponseParser {
    ...
    receiveChar(char) {
        if (this.current === this.WAITING_STATUS_LINE) {
            ...
            if (char === "\r") {
                this.headers[this.headerName] = this.headerValue; // headers 收集
                this.headerName = "";
                this.headerValue = "";
...
class TrunkedBodyParser {
    constructor() {
        ...
        this.WAITING_END_LINE = 5;
        this.WAITING_END_LINE_END = 6;
    ...
    receiveChar(char) {
        ...
        if (this.current === this.WAITING_LENGTH) {
            ...
            if (char === "\n") {
                this.current = this.WAITING_END_LINE;
            }
        } else if (this.current === this.WAITING_END_LINE) {
            if (char === "\r") {
                this.current = this.WAITING_END_LINE_END;
            }
        } else if (this.current === this.WAITING_END_LINE_END) {
            if (char === "\n") {
                this.current = this.WAITING_LENGTH;
            }
        }
